...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor"><i class="fa fa-map-o"></i> maintenance Support </h3>
		</div>
		<div class="col-md-7 align-self-center">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
				<li class="breadcrumb-item active"><i class="fa fa-plug" aria-hidden="true"></i> maintenance Suppor</li>
			</ol>
		</div>
	</div>
	<div class="container-fluid">
		<div class="row m-b-10">
			<div class="col-12">
				<button type="button" class="btn btn-info"><i class="fa fa-plug"></i><a data-toggle="modal"
																						data-target="#supportmodel"
																						data-whatever="@getbootstrap"
																						class="text-white"><i class=""
																											  aria-hidden="true"></i>
						Add maintenance Support</a></button>
				<button type="button" class="btn btn-primary"><i class="fa fa-server"></i><a
							href="<?php echo base_url(); ?>Projects/All_Assets" class="text-white"><i class=""
																									  aria-hidden="true"></i>
						Assets List</a></button>
				<button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a
							href="<?php echo base_url(); ?>Logistice/Logistic_Support" class="text-white"><i class=""
																											 aria-hidden="true"></i>
						maintenance Support </a></button>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
				<div class="card card-outline-info">
					<div class="card-header">
						<h4 class="m-b-0 text-white"> maintenance Support List</h4>
					</div>
								...
								<?php foreach ($supportview as $value): ?>
									<tr>
										...
										<td class="jsgrid-align-center ">
											<a href="#" title="Edit"
											   class="btn btn-sm btn-primary waves-effect waves-light logisticessupport"
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="select2 form-control custom-select assetsstock"
									...
									<div class="form-group">
										...
										<select class="form-control custom-select taskclass"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="startdate" class="form-control mydatetimepickerFull"
									...
									<div class="form-group">
										...
										<input type="text" name="assignqty" class="form-control"
											   id="recipient-name1 qty" value="" min="0" max="">
									</div><!--
                                            <div class="form-group">
									...
									<div class="form-group">
										...
										<textarea class="form-control col-md-8" name="remarks"
		...
		<!-- sample modal content -->
		<div class="modal fade" id="supportmodelupdate" tabindex="-1" role="dialog"
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control custom-select" data-placeholder="Choose a Category"
												tabindex="1" name="proid" id="OnEmValue" required>
											<option value="">Select Here</option>
											<?php foreach ($projects as $value): ?>
												<option value="<?php echo $value->id; ?>"><?php echo $value->pro_name; ?></option>
											<?php endforeach; ?>
									...
									<div class="form-group">
										<label class="control-label">Logistic List</label>
										<select class="form-control custom-select assetsstock"
												data-placeholder="Choose a Category" tabindex="1" name="logid" required>
											<option value="">Select Here</option>
											<?php foreach ($assets as $value): ?>
												<option value="<?php echo $value->ass_id; ?>"><?php echo $value->ass_name; ?></option>
											<?php endforeach; ?>
									...
									<div class="form-group">
										...
										<select class="form-control custom-select" data-placeholder="Choose a Category"
												tabindex="1" name="assignid" id="assignval" required>
											<option value="">Select here</option>
											<?php foreach ($employee as $value): ?>
												<option value="<?php echo $value->em_id ?>"><?php echo $value->first_name . ' ' . $value->last_name; ?></option>
											<?php endforeach; ?>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<input type="text" name="backdate" class="form-control mydatetimepickerFull"
											   id="recipient-name1" value="">
									</div>
									<span>In Stock:</span>
