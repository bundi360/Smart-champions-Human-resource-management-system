...
<div class="page-wrapper">
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor"><i class="fa fa-map-o" style="color:#1976d2"></i> Titles</h3>
		</div>
		...
		<div class="row">
			<div class="col-lg-5">
				<?php if (isset($editdesignation)) { ?>
					<div class="card card-outline-info">
						<div class="card-header">
							<h4 class="m-b-0 text-white">Edit Title</h4>
						</div>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="hidden" name="id"
													   value="<?php echo $editdesignation->id; ?>">
											</div>
										</div>
										<!--/span-->
									</div>
				...
				<?php } else { ?>
					...
					<div class="card card-outline-info">
						<div class="card-header">
							<h4 class="m-b-0 text-white"><i class="fa fa-id-card-o"></i> Add Title </h4>
						</div>
			...
			<div class="col-7">
				<div class="card card-outline-info">
					<div class="card-header">
						<h4 class="m-b-0 text-white"><i class="fa fa-id-card"></i> Title List</h4>
					</div>
