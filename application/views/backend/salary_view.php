				...
				<form method="post" action="pay_salary_add_record" id="generatePayrollForm"
					...
					<div class="modal-body">
						...
						<div class="row well">
							...
							<div class="col-md-6">
								...
								<div class="form-group row">
									...
									<div class="col-md-7">
										<input name="status" type="radio" id="radio_1" data-value="Paid"
											   class="duration" value="Paid" checked="checked">
										<label for="radio_1">Paid</label>
										<input name="status" type="radio" id="radio_2" data-value="Process" class="type"
											   value="Process">
						...
						<div class="form-group row" style="margin-top: 25px;">
							...
							<div class="col-md-9">
								<input name="paid_type" type="radio" id="radio_3" data-value="Hand Cash" class=""
									   value="Hand Cash" checked="checked">
								<label for="radio_3" style="margin-left: 30px">Hand Cash</label>
								<input name="paid_type" type="radio" id="radio_4" data-value="Bank" class="type"
									   value="Bank">
