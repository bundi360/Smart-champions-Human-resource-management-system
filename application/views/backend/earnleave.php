...
<div class="page-wrapper">
	...
	<div class="container-fluid">
		<div class="row m-b-10">
			<div class="col-12">
				<button type="button" class="btn btn-info"><i class="fa fa-plug"></i><a data-toggle="modal"
																						...
																						class="text-white TypeModal"><i
								class="" aria-hidden="true"></i> Assign Earned Leave </a></button>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
									...
									<tr>
										...
										<?php if ($value->present_date > 0) { ?>
											<td class="jsgrid-align-center">
												<a href="" title="Edit"
												   class="btn btn-sm btn-primary waves-effect waves-light deductionmodel"
												   data-id="<?php echo $value->em_id; ?>"><i
		...
		<div class="modal fade" id="earndeductionmodel" tabindex="-1" role="dialog"
