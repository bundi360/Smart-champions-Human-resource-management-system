            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10">
                    <div class="col-12">
                        ...
                        <?php } else { ?>
                        <button type="button" class="btn btn-info"><i class="fa fa-plug"></i><a data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Add Task </a></button>
                        <button type="button" class="btn btn-primary"><i class="fa fa-server"></i><a href="<?php echo base_url(); ?>Projects/All_Tasks" class="text-white"><i class="" aria-hidden="true"></i>  Project List</a></button>
