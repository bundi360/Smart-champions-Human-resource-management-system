		...
		<div class="row m-b-10">
			<div class="col-12">
				...
				<button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a
							href="<?php echo base_url(); ?>Payroll/Generate_salary" class="text-white"><i class=""
																										  aria-hidden="true"></i>
						Generate Payroll</a></button>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
							...
							<table id="example123" class="display nowrap table table-hover table-striped table-bordered"
								...
								foreach ($salary_info as $individual_info): ?>
									<tr>
										...
										<td><?php echo 'ksh' . $individual_info->basic; ?></td>
										<td><?php echo 'ksh' . $individual_info->loan; ?></td>
										<td><?php echo $individual_info->total_days; ?></td>
										<!--<td><?php echo $individual_info->addition; ?></td>-->
										<td><?php echo 'ksh' . $individual_info->diduction; ?></td>
										<td><?php echo 'ksh' . $individual_info->total_pay; ?></td>
