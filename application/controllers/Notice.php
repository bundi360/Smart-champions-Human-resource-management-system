...
//This funtcion displays the published notices.
		...
		if ($this->session->userdata('user_login_access') != False) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if ($_FILES['file_url']['name']) {
					...
					$config = array('file_name' => $new_file_name, 'upload_path' => "./assets/images/notice", 'allowed_types' => "gif|jpg|png|jpeg|pdf|doc|docx", 'overwrite' => False, 'max_size' => "50720000");
					...
					if (!$this->upload->do_upload('file_url')) {
						...
						$data = array();
						$data = array('title' => $filetitle, 'file_url' => $img_url, 'date' => $ndate);
