		...
		<div class="row">
			<div class="col-lg-5">
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" name="department" id="firstName"
													   value="<?php echo $editdepartment->dep_name; ?>"
													   class="form-control"
													   placeholder="">
												<input type="hidden" name="id"
													   value="<?php echo $editdepartment->id; ?>">
											</div>
										</div>
										<!--/span-->
									</div>
				...
				<?php } else { ?>
					...
					<div class="card card-outline-info">
						<div class="card-header">
							<h4 class="m-b-0 text-white"><i class="fa fa-cube" "></i>Add Department</h4>
						</div>
			...
			<div class="col-7">
				<div class="card card-outline-info">
					<div class="card-header">
						<h4 class="m-b-0 text-white"><i class="fa fa-list-alt"></i> Department List</h4>
					</div>
