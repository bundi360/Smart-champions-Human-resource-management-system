	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content ">
			<div class="modal-header">
				<h4 class="modal-title" id="exampleModalLabel1">Assign Maintenance Support</h4>
			...
			<form method="post" action="Add_Logistic" id="logisModalform" enctype="multipart/form-data">
				<div class="modal-body">
					<div class="form-group row">
						...
						<select class="form-control custom-select col-md-8" data-placeholder="Choose a Category"
					...
					<div class="form-group row">
						...
						<select class="select2 form-control custom-select col-md-4" data-placeholder="Choose a Category"
					...
					<div class="form-group row">
						<label class="control-label col-md-3">maintenance Support</label>
		...
		<div class="modal-content ">
			...
			<form method="post" action="Add_Tasks" id="tasksModalform" enctype="multipart/form-data">
				<div class="modal-body">
					<div class="form-group row">
						<label class="control-label col-md-3">Project List</label>
						<select class="form-control custom-select col-md-8 proid" data-placeholder="Choose a Category"
					...
					<div class="form-group row">
						...
						<select class="select2 form-control custom-select col-md-3" data-placeholder="Choose a Category"
								style="width:25%" tabindex="1" name="teamhead">
							<option value="">Select Here</option>
					...
					<div class="form-group row">
						...
						<input name="type" type="radio" id="radio_4" data-value="Office" class="type" value="Office"
							   checked>
		...
		<div class="modal-content ">
			...
			<form method="post" action="Add_Field_Tasks" id="tasksModalform" enctype="multipart/form-data">
				<div class="modal-body">
					<div class="form-group row">
						<label class="control-label col-md-3">Project List</label>
						<select class="form-control custom-select col-md-6 proid" data-placeholder="Choose a Category"
								tabindex="1" name="projectid">
							<option value="<?php echo $details->id; ?>"><?php echo $details->pro_name; ?></option>
						</select>
					</div>
